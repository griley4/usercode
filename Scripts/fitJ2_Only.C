...
void fitJ2_Only(){
  ...
  RooRealVar FourMu_Mass("FourMu_Mass","FourMu_Mass",6.,60.);
  ...
  RooRealVar Psi1To2_dY("Psi1To2_dY","Psi1To2_dY",0,3.8);
...
//mass 2 bkg shape
 // bkg_p3mass2 = new RooRealVar("bkg_p3mass2","",0,-1,1);
  ...
  RooArgSet dataVars(Psi2_Mass, Psi1_Mass, Psi1_CTxy, Psi2_CTxy, Psi1To2Significance); 
 ...
 // RooDataSet* readdata = RooDataSet::read("Selected_pt10_y1p2.txt",dataVars);
  ...
  //RooDataSet* readdata = RooDataSet::read("Selected_pt8p5_y2p1.txt",dataVars);
  //RooDataSet* readdata = RooDataSet::read("Selected_pt8_y1p9.txt",dataVars);
  //RooDataSet* readdata = RooDataSet::read("Selected_pt8p5_y1p9.txt",dataVars);
  //RooDataSet* readdata = RooDataSet::read("Selected_ptLE8_yGE0p95.txt",dataVars);
  //RooDataSet* readdata = RooDataSet::read("Selected_psipt7850.txt",dataVars);
  //RooDataSet* readdata = RooDataSet::read("Selected_psipt8150.txt",dataVars);
  RooDataSet* data ;
  ...
  RooRealVar nbkg("nbkg","number of background events",1,0,1);
