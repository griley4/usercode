...
//=========  (Thu May 11 09:22:34 2017) by ROOT version5.26/00
...
// ------------>Primitives in pad: acc_1
   ...
   acc_1->Draw();
   acc_1->cd();
   acc_1->Range(-0.39275,0.004272223,3.53475,0.06141731);
   ...
   acc_1->SetFrameFillStyle(0);
   acc_1->SetFrameBorderMode(0);
   Double_t xAxis1[13] = {0, 0.25, 0.5, 0.75, 1, 1.25, 1.5, 1.75, 2, 2.25, 2.5, 2.75, 3.142}; 
   
   TH1D *acc_eff_shape_dps = new TH1D("acc_eff_shape_dps","acc_eff_shape_dps",12, xAxis1);
   acc_eff_shape_dps->SetBinContent(1,0.0219156);
   acc_eff_shape_dps->SetBinContent(2,0.03049796);
   acc_eff_shape_dps->SetBinContent(3,0.01701279);
   acc_eff_shape_dps->SetBinContent(4,0.02502881);
   acc_eff_shape_dps->SetBinContent(5,0.02910382);
   acc_eff_shape_dps->SetBinContent(6,0.02509997);
   acc_eff_shape_dps->SetBinContent(7,0.01737188);
   acc_eff_shape_dps->SetBinContent(8,0.03502272);
   acc_eff_shape_dps->SetBinContent(9,0.01878214);
   acc_eff_shape_dps->SetBinContent(10,0.03258244);
   acc_eff_shape_dps->SetBinContent(11,0.04543834);
   acc_eff_shape_dps->SetBinContent(12,0.03826386);
   acc_eff_shape_dps->SetBinError(1,0.005720252);
   acc_eff_shape_dps->SetBinError(2,0.006755924);
   acc_eff_shape_dps->SetBinError(3,0.004952771);
   acc_eff_shape_dps->SetBinError(4,0.006145876);
   acc_eff_shape_dps->SetBinError(5,0.006601833);
   acc_eff_shape_dps->SetBinError(6,0.006163564);
   acc_eff_shape_dps->SetBinError(7,0.005058202);
   acc_eff_shape_dps->SetBinError(8,0.007273095);
   acc_eff_shape_dps->SetBinError(9,0.005257922);
   acc_eff_shape_dps->SetBinError(10,0.006903702);
   acc_eff_shape_dps->SetBinError(11,0.008087507);
   acc_eff_shape_dps->SetBinError(12,0.005945775);
   acc_eff_shape_dps->SetBinError(13,nan);
   acc_eff_shape_dps->SetEntries(242.082);
...
// ------------>Primitives in pad: acc_2
   ...
   acc_2->Draw();
   acc_2->cd();
   acc_2->Range(-0.39275,0.1550606,3.53475,0.3181378);
   ...
   acc_2->SetFrameFillStyle(0);
   acc_2->SetFrameBorderMode(0);
   Double_t xAxis2[13] = {0, 0.25, 0.5, 0.75, 1, 1.25, 1.5, 1.75, 2, 2.25, 2.5, 2.75, 3.142}; 
   
   TH1D *acc_shape = new TH1D("acc_shape","acc_shape",12, xAxis2);
   acc_shape->SetBinContent(1,0.1957793);
   acc_shape->SetBinContent(2,0.2323654);
   acc_shape->SetBinContent(3,0.2410146);
   acc_shape->SetBinContent(4,0.2429267);
   acc_shape->SetBinContent(5,0.2270098);
   acc_shape->SetBinContent(6,0.2022763);
   acc_shape->SetBinContent(7,0.2157009);
   acc_shape->SetBinContent(8,0.2436998);
   acc_shape->SetBinContent(9,0.2412783);
   acc_shape->SetBinContent(10,0.2734092);
   acc_shape->SetBinContent(11,0.2684993);
   acc_shape->SetBinContent(12,0.274076);
   acc_shape->SetBinError(1,0.01849439);
   acc_shape->SetBinError(2,0.02039301);
   acc_shape->SetBinError(3,0.02059241);
   acc_shape->SetBinError(4,0.02108415);
   acc_shape->SetBinError(5,0.0201329);
   acc_shape->SetBinError(6,0.01894902);
   acc_shape->SetBinError(7,0.01948373);
   acc_shape->SetBinError(8,0.02103075);
   acc_shape->SetBinError(9,0.0208015);
   acc_shape->SetBinError(10,0.02220846);
   acc_shape->SetBinError(11,0.02165563);
   acc_shape->SetBinError(12,0.01762761);
   acc_shape->SetBinError(13,nan);
   acc_shape->SetEntries(1930.891);
...
// ------------>Primitives in pad: acc_3
   ...
   acc_eff_shape_dps_pt1->SetBinError(8,nan);
...
// ------------>Primitives in pad: acc_4
   ...
   acc_shape_pt1->SetBinError(9,nan);
...
// ------------>Primitives in pad: acc_5
   ...
   acc_eff_shape_dps_pt2->SetBinError(2,0.00276256);
   acc_eff_shape_dps_pt2->SetBinError(3,0.001791724);
   acc_eff_shape_dps_pt2->SetBinError(4,0.005013714);
   acc_eff_shape_dps_pt2->SetBinError(5,0.01165422);
   acc_eff_shape_dps_pt2->SetBinError(6,inf);
   acc_eff_shape_dps_pt2->SetBinError(7,inf);
   acc_eff_shape_dps_pt2->SetBinError(8,inf);
...
// ------------>Primitives in pad: acc_6
   ...
   acc_shape_pt2->SetBinError(7,nan);
   acc_shape_pt2->SetBinError(8,nan);
