...
int Xsec_calcTtreeFewerbins_newvars() {
  gROOT->Reset();
...
dps_frac_dp->SetBinContent(1,0.0361954);
dps_frac_dp->SetBinContent(2,0.0729861);
dps_frac_dp->SetBinContent(3,0.181934);
dps_frac_dp->SetBinContent(4,0.234756);
dps_frac_dp->SetBinContent(5,0.254449);

   TH1D *dps_frac_pt1= new TH1D("dps_frac_pt1","dps_frac_pt1",npt1bins, pt1bins);
dps_frac_pt1->SetBinContent(1,0.0945227);
dps_frac_pt1->SetBinContent(2,0.159892);
dps_frac_pt1->SetBinContent(3,0.175043);
dps_frac_pt1->SetBinContent(4,0.180356);
dps_frac_pt1->SetBinContent(5,0.160345);
dps_frac_pt1->SetBinContent(6,0.108137);
dps_frac_pt1->SetBinContent(7,0);

   TH1D *dps_frac_pt2= new TH1D("dps_frac_pt2","dps_frac_pt2",npt2bins, pt2bins);
dps_frac_pt2->SetBinContent(1,0.277354);
dps_frac_pt2->SetBinContent(2,0.142238);
dps_frac_pt2->SetBinContent(3,0.0649329);
dps_frac_pt2->SetBinContent(4,0.0250744);
dps_frac_pt2->SetBinContent(5,0);
dps_frac_pt2->SetBinContent(6,0);

   TH1D *dps_frac_pta = new TH1D("dps_frac_pta","dps_frac_pta",nptabins, ptabins);
dps_frac_pta->SetBinContent(1,0.138294);
dps_frac_pta->SetBinContent(2,0.133987);
dps_frac_pta->SetBinContent(3,0.112402);
dps_frac_pta->SetBinContent(4,0.145906);
dps_frac_pta->SetBinContent(5,0.103032);
