...
// -- acceptance x efficiency shape
  ...
  disp->cd(1);
  gendps_tot = gendps.Draw("FourMu_Mass >> fourmu_mass","Sum$(abs(Psi_y)<=1.2&&Psi_pT>6.5||abs(Psi_y)>1.2&&abs(Psi_y)<1.43&&(Psi_pT>-8.7*abs(Psi_y)+16.93)||abs(Psi_y)>1.43&&abs(Psi_y)<2.2&&Psi_pT>4.5)==2&&Sum$(Psi_Mass[]<3.35&&Psi_Mass>2.85)==2","");
  gendps_tot = gendps_tot*genscale;
  fourmu_mass.Scale(genscale);
  disp->cd(2);
  gendps_acc = gendps.Draw("FourMu_Mass >> fourmu_mass_alt2","Sum$(abs(Psi_y)<=1.2&&Psi_pT>6.5||abs(Psi_y)>1.2&&abs(Psi_y)<1.43&&(Psi_pT>-8.7*abs(Psi_y)+16.93)||abs(Psi_y)>1.43&&abs(Psi_y)<2.2&&Psi_pT>4.5)==2&&Sum$(Psi_Mass[]<3.35&&Psi_Mass>2.85)==2&&Sum$(Mu_pT[]>3.5&&Mu_Eta[]<1.2||Mu_Eta>1.2&&Mu_Eta<1.6&&Mu_pT>-3.75*Mu_Eta[]+8.||Mu_Eta>1.6&&Mu_Eta<2.4&&Mu_pT>2.0)>=3&&Sum$(Mu_Eta[]<1.2&&Mu_pT>3.0||Mu_Eta<2.4&&Mu_Eta>1.2&&sqrt(pow(Mu_px,2)+pow(Mu_py,2)+pow(Mu_pz,2)) > 3.0)==4","");
  gendps_acc = gendps_acc*accscale;
  fourmu_mass_alt2.Scale(accscale);
  disp->cd(3);
  recodps_tot = recodps.Draw("FourMu_Mass >> fourmu_mass_alt","Sum$(abs(Psi_y)<=1.2&&Psi_pT>6.5||abs(Psi_y)>1.2&&abs(Psi_y)<1.43&&(Psi_pT>-8.7*abs(Psi_y)+16.93)||abs(Psi_y)>1.43&&abs(Psi_y)<2.2&&Psi_pT>4.5)==2&&Sum$(Psi_Mass[]<3.35&&Psi_Mass>2.85)==2&&Sum$(Mu_pT[]>3.5&&Mu_Eta[]<1.2||Mu_Eta>1.2&&Mu_Eta<1.6&&Mu_pT>-3.75*Mu_Eta[]+8.||Mu_Eta>1.6&&Mu_Eta<2.4&&Mu_pT>2.0)>=3&&Sum$(Mu_Eta[]<1.2&&Mu_pT>3.0||Mu_Eta<2.4&&Mu_Eta>1.2&&sqrt(pow(Mu_px,2)+pow(Mu_py,2)+pow(Mu_pz,2)) > 3.0)==4","");
...
//pT dists
  ...
  disp->cd(4);
    ...
    gendps_tot = gendps.Draw("FourMu_pT >> fourmu_pt","Sum$(abs(Psi_y)<2.1&&Psi_pT>8.5)==2&&Sum$(Psi_Mass[]<3.35&&Psi_Mass>2.85)==2","");
  gendps_tot = gendps_tot*genscale;
  fourmu_pt.Scale(genscale);
  disp->cd(5);
    gendps_acc = gendps.Draw("FourMu_pT >> fourmu_pt_alt2","Sum$(abs(Psi_y)<2.1&&Psi_pT>8.5)==2&&Sum$(Psi_Mass[]<3.4&&Psi_Mass>2.8)==2&&((Mu_pT[0]>=4&&Mu_pT[1]>=4)||(Mu_pT[2]>=4&&Mu_pT[3]>=4))&&Sum$(Mu_pT>=2.5&&abs(Mu_Eta)<2.3)==4","");
  gendps_acc = gendps_acc*accscale;
  fourmu_pt_alt2.Scale(accscale);
  disp->cd(6);
    recodps_tot = recodps.Draw("FourMu_pT >> fourmu_pt_alt","Sum$(abs(Psi_y)<2.1&&Psi_pT>8.5)==2&&Sum$(Psi_Mass[]<3.4&&Psi_Mass>2.8)==2&&((Mu_pT[0]>=4&&Mu_pT[1]>=4)||(Mu_pT[2]>=4&&Mu_pT[3]>=4))&&Sum$(Mu_pT>=2.5&&abs(Mu_Eta)<2.3)==4","");
  ...
  disp->cd(12);
   recodps_tot = recodps.Draw("abs(FourMu_Rapidity) >> fourmu_y_alt","FourMu_Mass>=0&&FourMu_Mass<=60&&FourMu_VtxProb>=0.1&&Sum$(abs(Psi_y)<=0.95&&Psi_pT>8.0||abs(Psi_y)>0.95&&abs(Psi_y)<1.4&&(Psi_pT>-5.55*abs(Psi_y)+13.3)||abs(Psi_y)>=1.4&&abs(Psi_y)<=1.9&&Psi_pT>5.5)==2&&Sum$(abs(Mu_Eta)<=1.2&&Mu_pT>3.5||abs(Mu_Eta)>1.2&&abs(Mu_Eta)<1.6&&(Mu_pT>-3.75*abs(Mu_Eta)+8)||abs(Mu_Eta)>=1.6&&abs(Mu_Eta)<=2.0&&Mu_pT>2.0)==4","");
