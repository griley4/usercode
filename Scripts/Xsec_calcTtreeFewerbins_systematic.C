...
//  dps_frac_mass->SetBinContent(1,0.0436147);
//  dps_frac_mass->SetBinContent(2,0.0276824);
//  dps_frac_mass->SetBinContent(3,0.0398697);
//  dps_frac_mass->SetBinContent(4,0.0879224);
//  dps_frac_mass->SetBinContent(5,0.207871);
//  dps_frac_mass->SetBinContent(6,0.255323);
//  dps_frac_mass->SetBinContent(7,0.381423);
//  dps_frac_mass->SetBinContent(8,0.572553);
   dps_frac_mass->SetBinContent(1,0.0177447);
   dps_frac_mass->SetBinContent(2,0.0111524);
   dps_frac_mass->SetBinContent(3,0.0161834);
   dps_frac_mass->SetBinContent(4,0.0367821);
   dps_frac_mass->SetBinContent(5,0.0941653);
   dps_frac_mass->SetBinContent(6,0.119579);
   dps_frac_mass->SetBinContent(7,0.196311);
   dps_frac_mass->SetBinContent(8,0.346666);


   TH1D *dps_frac_pt= new TH1D("dps_frac_pt","dps_frac_pt",nptbins, ptbins);
//  dps_frac_pt->SetBinContent(1,0.367324);
//  dps_frac_pt->SetBinContent(2,0.319295);
//  dps_frac_pt->SetBinContent(3,0.304183);
//  dps_frac_pt->SetBinContent(4,0.179518);
//  dps_frac_pt->SetBinContent(5,0.0723175);
//  dps_frac_pt->SetBinContent(6,0.0116971);
//  dps_frac_pt->SetBinContent(7,0);
   dps_frac_pt->SetBinContent(1,0.186986);
   dps_frac_pt->SetBinContent(2,0.156697);
   dps_frac_pt->SetBinContent(3,0.147612);
   dps_frac_pt->SetBinContent(4,0.0797597);
   dps_frac_pt->SetBinContent(5,0.0299557);
   dps_frac_pt->SetBinContent(6,0.00466658);
   dps_frac_pt->SetBinContent(7,0);


   TH1D *dps_frac_dy= new TH1D("dps_frac_dy","dps_frac_dy",ndybins, dybins);
//  dps_frac_dy->SetBinContent(1,0.054287);
//  dps_frac_dy->SetBinContent(2,0.0772808);
//  dps_frac_dy->SetBinContent(3,0.062288);
//  dps_frac_dy->SetBinContent(4,0.193245);
//  dps_frac_dy->SetBinContent(5,0.338642);
//  dps_frac_dy->SetBinContent(6,0.578595);
//  dps_frac_dy->SetBinContent(7,0.910835);
//  dps_frac_dy->SetBinContent(8,0.952982);
   dps_frac_dy->SetBinContent(1,0.0222339);
   dps_frac_dy->SetBinContent(2,0.0321122);
   dps_frac_dy->SetBinContent(3,0.0256388);
   dps_frac_dy->SetBinContent(4,0.0866646);
   dps_frac_dy->SetBinContent(5,0.168633);
   dps_frac_dy->SetBinContent(6,0.352289);
   dps_frac_dy->SetBinContent(7,0.801847);
   dps_frac_dy->SetBinContent(8,0.889246);
   
   TH1D *dps_frac_y = new TH1D("dps_frac_y","dps_frac_y",nybins, ybins);
//  dps_frac_y->SetBinContent(1,0.373743);
//  dps_frac_y->SetBinContent(2,0.251832);
//  dps_frac_y->SetBinContent(3,0.190912);
//  dps_frac_y->SetBinContent(4,0.204722);
//  dps_frac_y->SetBinContent(5,0.136266);
//  dps_frac_y->SetBinContent(6,0.159192);
//  dps_frac_y->SetBinContent(7,0.119037);
//  dps_frac_y->SetBinContent(8,0.0983413);
//  dps_frac_y->SetBinContent(9,0.122462);
   dps_frac_y->SetBinContent(1,0.191206);
   dps_frac_y->SetBinContent(2,0.117651);
   dps_frac_y->SetBinContent(3,0.0854817);
   dps_frac_y->SetBinContent(4,0.0925376);
   dps_frac_y->SetBinContent(5,0.0588199);
   dps_frac_y->SetBinContent(6,0.0697686);
   dps_frac_y->SetBinContent(7,0.050807);
   dps_frac_y->SetBinContent(8,0.0414159);
   dps_frac_y->SetBinContent(9,0.0523856);
...
tnp_diff_y->SetBinContent(9,  0.16372 );
  ...
  for(int mbin=1; mbin<=nmbins; ++mbin){
    corrPop = mass_data->GetBinContent(mbin)/(0.0596*0.0596*20.2*(1+0.5*tnp_diff_m->GetBinContent(mbin))*((dps_frac_mass->GetBinContent(mbin)*acc_eff_shape_dps->GetBinContent(mbin))+((1-dps_frac_mass->GetBinContent(mbin))*acc_eff_shape_nlo->GetBinContent(mbin)))*(massbins[mbin]-massbins[mbin-1]));
  ...
  for(int ptbin=1; ptbin<=nptbins; ++ptbin){
    corrPoppt = pt_data->GetBinContent(ptbin)/(pow(0.0596,2)*20.2*(1+0.5*tnp_diff_pt->GetBinContent(ptbin))*((dps_frac_pt->GetBinContent(ptbin)*acc_eff_shape_dps_pt->GetBinContent(ptbin))+((1.-dps_frac_pt->GetBinContent(ptbin))*acc_eff_shape_nlo_pt->GetBinContent(ptbin)))*(ptbins[ptbin]-ptbins[ptbin-1]));
...
//            std::cout<<pt_data->GetBinContent(ptbin)<<" over "<<0.0593*0.0593*20.339<<" times "<<fracDPS<<" times "<<acc_eff_shape_dps_pt->GetBinContent(ptbin)<<" + "<<fracNLO<<" times "<<acc_eff_shape_nlo_pt->GetBinContent(ptbin)<<" times "<<(ptbins[ptbin]-ptbins[ptbin-1])<<" equals??? "<<corrPoppt<<std::endl;
  ...
  for(int dybin=1; dybin<=ndybins; ++dybin){
    corrPopdy = dy_data->GetBinContent(dybin)/(pow(0.0596,2)*20.2*(1+0.5*tnp_diff_dy->GetBinContent(dybin))*(dps_frac_dy->GetBinContent(dybin)*acc_eff_shape_dps_dy->GetBinContent(dybin)+(1-dps_frac_dy->GetBinContent(dybin))*acc_eff_shape_nlo_dy->GetBinContent(dybin))*(dybins[dybin]-dybins[dybin-1]));
  ...
  for(int ybin=1; ybin<=nybins; ++ybin){
    corrPopy = y_data->GetBinContent(ybin)/(pow(0.0596,2)*20.2*(1+0.5*tnp_diff_y->GetBinContent(ybin))*(dps_frac_y->GetBinContent(ybin)*acc_eff_shape_dps_y->GetBinContent(ybin)+(1-dps_frac_y->GetBinContent(ybin))*acc_eff_shape_nlo_y->GetBinContent(ybin))*(ybins[ybin]-ybins[ybin-1]));
    //          std::cout<<dy_data->GetBinContent(dybin)<<" over "<<0.0593*0.0593*20.339<<" times "<<((fracDPS*acc_eff_shape_dps_dy->GetBinContent(dybin))+(fracNLO*acc_eff_shape_nlo_dy->GetBinContent(dybin)))<<" times "<<(dybins[dybin]-dybins[dybin-1])<<" equals??? "<<corrPopdy<<std::endl;
