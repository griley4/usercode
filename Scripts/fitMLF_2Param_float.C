...
//-- These are signal mc fit parameters for dsig
  ...
  data = new RooDataSet("data","data",readdata ,dataVars);
    ...
    //RooProdPdf sig_model("sig_model","sig_model",RooArgList(sigmcct_1,sigmcct_2,sig_distT));
    //RooProdPdf bkg_model("bkg_model","bkg_model",RooArgList(bkg_CT1_SB1,bkg_CT2_SB1,bkg_landau2));
  ...
  //sig_model.fitTo(*data,Hesse(kTRUE),Minos(kFALSE));
  //  RooPlot* frame2 = Psi1_Mass.frame(Title("#mu^{+}#mu^{-}#mu^{+}#mu^{-} ct"));
  //  frame2 = Psi1_Mass.frame(30);
  //  data->plotOn(frame2,DrawOption("p"));
  //  model.plotOn(frame2);
  //  model.plotOn(frame2,RooFit::Name("signal"),RooFit::Components("sig_*"),RooFit::LineColor(kRed), RooFit::LineStyle(kDashed));
  //  model.plotOn(frame2,RooFit::Name("background"),RooFit::Components("bkg_model"),RooFit::LineColor(kGreen), RooFit::LineStyle(kDashed));
  //  TCanvas* c2 = new TCanvas("c2","",10,10,700,700);
  //  c2->cd();
  //  c2->SetFillColor(kWhite);
  //  frame2->SetTitle("");
  //  frame2->SetMaximum(1000);
  //  frame2->SetMinimum(2.0);
  //  frame2->SetXTitle("J/#psi^{2} ct_{xy} [cm]");
  ...
  //  c2->SetLogy();
    ...
    model.plotOn(frame5);
    model.plotOn(frame5,RooFit::Name("signal"),RooFit::Components("sig_*"),RooFit::LineColor(kRed), RooFit::LineStyle(kDashed));
    model.plotOn(frame5,RooFit::Name("background"),RooFit::Components("bkg_model"),RooFit::LineColor(kGreen), RooFit::LineStyle(kDashed));
    TCanvas* c5 = new TCanvas("c5","",10,10,700,700);
    c5->cd();
    ...
    frame5->SetTitleOffset(1.2,"Y");
    frame5->Draw();
    float chi1 = frame5->chiSquare();
  ...
  TCanvas* c3 = new TCanvas("c3","",10,10,700,700);
  c3->cd();
  ...
  std::cout<<"chi ctxy = "<<chi1<<" and chi dsig = "<<chi2<<std::endl;
