...
#include "TFile.h"
#include "TTree.h"
void fitMLFfixedsignal_fixedbkg() {
...
//roodecay ctxy bkg paramaterization
  RooRealVar ct_mean_core("ctmeancore","",0.03,0,1);
  RooRealVar ct_sigma_core("ctsigmacore","",0.03,0,1);
...
//--These are bkg parameters for dsig
  ...
  RooRealVar nbkg("nbkg","number of background events",200,0,5000);
