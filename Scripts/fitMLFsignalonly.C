...
//--yo, these are DPSMC Fit parameters in ctxy
  ...
  RooRealVar sigmcR_sigma_coreCT1("sigmcR_sigma_coreCT1","",3.54461e-03,0,1);
  RooRealVar sigmcR_sigma_tailCT1("sigmcR_sigma_tailCT1","",2.04622e-03);
  //RooRealVar sigmcR_sigma_coreCT1("sigmcR_sigma_coreCT1","",5.09628e-03,0,1);
  //RooRealVar sigmcR_sigma_tailCT1("sigmcR_sigma_tailCT1","",2.18344e-03,0,1);
  RooFormulaVar R_sigma_totCT1("sigmcR_sigma_totCT1","","",RooArgList(sigmcR_sigma_coreCT1,sigmcR_sigma_tailCT1));
  RooRealVar sigmcR_fracCT1("sigmcR_fracCT1","",1.85e-01);
  //RooRealVar sigmcR_fracCT1("sigmcR_fracCT1","",1.90423e-01,0,1);
...
//roodecay ctxy bkg paramaterization
  ...
  RooRealVar ct_lambda("ctlambda","",0.5);
...
//--These are bkg parameters for dsig
    ...
    RooRealVar bkg_meanlandau2("bkg_meanlandau2","",0);
    RooRealVar bkg_sigmalandau2("bkg_sigmalandau2","",0);
  ...
  frame3 = Psi1To2Significance.frame(15);
  data->plotOn(frame3);
  model.plotOn(frame3);
