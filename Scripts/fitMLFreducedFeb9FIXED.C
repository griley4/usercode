...
//mass 2 signal fixed to resonaance mc
  ...
  jpsi2_mass_1 = new RooRealVar("jpsi2_mass_2","",3.09352e+00,3,4);
...
//--yo, these are SigMC Fit parameters in ctxy
  RooRealVar sigmcR_mean_coreCT1("sigmcR_mean_coreCT1","",1.28089e-03);
  RooRealVar sigmcR_mean_tailCT1("sigmcR_mean_tailCT1","",4.02197e-06);
  RooRealVar sigmcR_sigma_coreCT1("sigmcR_sigma_coreCT1","",6.88879e-03);
  RooRealVar sigmcR_sigma_tailCT1("sigmcR_sigma_tailCT1","",2.36767e-03);
  RooFormulaVar R_sigma_totCT1("sigmcR_sigma_totCT1","","",RooArgList(sigmcR_sigma_coreCT1,sigmcR_sigma_tailCT1));
  RooRealVar sigmcR_fracCT1("sigmcR_fracCT1","",9.62879e-02);
...
//roodecay ctxy bkg paramaterization
    ...
    RooRealVar ct_lambda("ctlambda","",2.95464e-03);
...
//-- These are signal mc fit parameters for dsig
    ...
    RooRealVar R_mean_core("R_mean_core","",4.29674e-01);
    RooRealVar R_sigma_core("R_sigma_core","",2.88876e-01);
    RooRealVar etab_lambda("etab_lambda","",5.17412e-01);
    ...
    RooRealVar bkg_co02("bkg_co02","",9.99454e-01);
    RooRealVar bkg_co12("bkg_co12","",8.23944e-01);
    RooRealVar bkg_flau2("bkg_flau2","",1);
    RooRealVar bkg_meanlandau2("bkg_meanlandau2","",7.16830e-01,0,2);
    RooRealVar bkg_sigmalandau2("bkg_sigmalandau2","",2.97624e-01,0,2);
