...
//--mass 1 signal fixed to DPS MC
  ...
  jpsi1_mass_1 = new RooRealVar("jpsi1_mass_1","",3.09616e+00,2.9,4);
  jpsi1_width_1 = new RooRealVar("jpsi1_width_1","",7.74729e-02,0,1);
  jpsi1_alpha= new RooRealVar("jpsi1_alpha","",7.74729e-02,0,4);
  jpsi1_n = new RooRealVar("jpsi1_n","",7.74729e-02,-3,3);
  RooCBShape jpsi1mass("jpsi1mass","jpsi mass distribution",Psi1_Mass,*jpsi1_mass_1,*jpsi1_width_1, *jpsi1_alpha, *jpsi1_n);
//-- bkg params for mass 1

  bkg_jpsi1_mass_1 = new RooRealVar("bkg_jpsi1_mass_1","",3.09313e+00);
  bkg_jpsi1_width_1 = new RooRealVar("bkg_jpsi1_width_1","",5.20963e-02,0,1);
  ...
  bkg_p3 = new RooRealVar("bkg_p3","",-1.81248e-01,-1,1);
  bkg_p4 = new RooRealVar("bkg_p4","",-4.66191e-01,-1,1);
  bkg_p5 = new RooRealVar("bkg_p5","",0);
  //bkg_p5 = new RooRealVar("bkg_p5","",4.49594e-01,-1,1);
  ...
  RooGaussian bkg_jpsi1mass_2("bkg_jpsi1mass_2","jpsi mass distribution",Psi1_Mass,*jpsi1_mass_1,*bkg_jpsi1_width_2);
  ...
  frac_bkg = new RooRealVar("frac_bkg","",7.75667e-01,0,1);
  RooAddPdf bkg_mass1model("bkg_mass1model","jpsi 1 bkg model",RooArgList(bkg_jpsi1mass_1,bkg_jpsi1mass_Pol),RooArgList(*frac_bkg));


//mass 2 signal fixed to DPS mc

  jpsi2_mass_1 = new RooRealVar("jpsi2_mass_2","",3.09616e+00,2.9,4);
  jpsi2_width_1 = new RooRealVar("jpsi2_width_1","",8.49500e-02,0,1);
  jpsi2_alpha= new RooRealVar("jpsi2_alpha","",8.49500e-02,0,4);
  jpsi2_n = new RooRealVar("jpsi2_n","",8.49500e-02,-3,3);
  RooCBShape jpsi2mass("jpsi2mass","jpsi mass distribution",Psi2_Mass,*jpsi2_mass_1,*jpsi1_width_1, *jpsi2_alpha, *jpsi2_n);



//mass 2 bkg shape
  bkg_jpsi2_mass_1 = new RooRealVar("bkg_jpsi2_mass_1","",3.08933e+00,2.9,4);
  ...
  RooRealVar*    bkg_frac_7 = new RooRealVar("bkg_frac_7","",0);
  bkg_p3mass2 = new RooRealVar("bkg_p3mass2","",-5.26058e-01,-1,1);
  bkg_p4mass2 = new RooRealVar("bkg_p4mass2","",6.33263e-01,-1,1);
  bkg_p5mass2 = new RooRealVar("bkg_p5mass2","",8.80738e-02,-1,1);
...
//--yo, these are DPSMC Fit parameters in ctxy
  RooRealVar sigmcR_mean_coreCT1("sigmcR_mean_coreCT1","",1.93295e-04,-1,1);
  RooRealVar sigmcR_mean_tailCT1("sigmcR_mean_tailCT1","",4.07126e-05);
  RooRealVar sigmcR_sigma_coreCT1("sigmcR_sigma_coreCT1","",6.70e-03,0,1);
  RooRealVar sigmcR_sigma_tailCT1("sigmcR_sigma_tailCT1","",2.27e-03,0,1);
  RooFormulaVar R_sigma_totCT1("sigmcR_sigma_totCT1","","",RooArgList(sigmcR_sigma_coreCT1,sigmcR_sigma_tailCT1));
  RooRealVar sigmcR_fracCT1("sigmcR_fracCT1","",1.85e-01,0,1);
  RooGaussian sigmcct_1a("sigmcct_1a","ct distributionsigmc",Psi1_CTxy,sigmcR_mean_coreCT1,sigmcR_sigma_coreCT1);
  RooGaussian sigmcct_1b("sigmcct_1b","ct distributionsigmc",Psi1_CTxy,sigmcR_mean_coreCT1,sigmcR_sigma_tailCT1);
...
//roodecay ctxy bkg paramaterization
  RooRealVar ct_mean_core("ctmeancore","",0.0,-1,1);
  RooRealVar ct_sigma_core("ctsigmacore","",3.0e-3,0,1);
  RooRealVar ct_lambda("ctlambda","",2.42748e-03,0,1);
  //RooGaussModel resolute_cour("resolute_cour","",Psi1_CTxy,sigmcR_mean_coreCT1,ct_sigma_core);
...
//--These are bkg parameters for dsig
    ...
    RooRealVar bkg_meanlandau2("bkg_meanlandau2","",6.34623e-01,0,3);
    RooRealVar bkg_sigmalandau2("bkg_sigmalandau2","",2.37338e-01,0,3);
  ...
  //RooAddPdf model("model","model",RooArgList(jpsi2mass,bkg_mass2model),RooArgList(nsig,nbkg));
  ...
  frame3 = Psi1To2Significance.frame(22);
  data->plotOn(frame3);
  model.plotOn(frame3);
