...
//=========  (Wed Jul 26 11:43:10 2017) by ROOT version5.26/00
...
// ------------>Primitives in pad: acc_1
   ...
   acc_1->Draw();
   acc_1->cd();
   acc_1->Range(-0.39275,0.02481251,3.53475,0.04200685);
   ...
   acc_eff_shape_dps->SetBinContent(1,0.03755475);
   acc_eff_shape_dps->SetBinContent(2,0.035136);
   acc_eff_shape_dps->SetBinContent(3,0.02933197);
   acc_eff_shape_dps->SetBinContent(4,0.03368309);
   acc_eff_shape_dps->SetBinContent(5,0.03575284);
   acc_eff_shape_dps->SetBinError(1,0.002077641);
   acc_eff_shape_dps->SetBinError(2,0.001539773);
   acc_eff_shape_dps->SetBinError(3,0.002176197);
   acc_eff_shape_dps->SetBinError(4,0.002657979);
   acc_eff_shape_dps->SetBinError(5,0.002646718);
   acc_eff_shape_dps->SetBinError(6,nan);
   acc_eff_shape_dps->SetEntries(1157.698);
...
// ------------>Primitives in pad: acc_2
   ...
   acc_2->Draw();
   acc_2->cd();
   acc_2->Range(-0.39275,0.1123008,3.53475,0.151701);
   ...
   acc_shape->SetBinContent(1,0.1420212);
   acc_shape->SetBinContent(2,0.1367631);
   acc_shape->SetBinContent(3,0.1287783);
   acc_shape->SetBinContent(4,0.1229636);
   acc_shape->SetBinContent(5,0.1301479);
   acc_shape->SetBinError(1,0.004238833);
   acc_shape->SetBinError(2,0.003183474);
   acc_shape->SetBinError(3,0.004775024);
   acc_shape->SetBinError(4,0.005293256);
   acc_shape->SetBinError(5,0.005274856);
   acc_shape->SetBinError(6,nan);
   acc_shape->SetEntries(4145.662);
...
// ------------>Primitives in pad: acc_5
   ...
   acc_eff_shape_dps_pt2->SetBinError(2,0.002144308);
   acc_eff_shape_dps_pt2->SetBinError(3,0.001364279);
   acc_eff_shape_dps_pt2->SetBinError(4,0.001921981);
   acc_eff_shape_dps_pt2->SetBinError(5,0.002499339);
