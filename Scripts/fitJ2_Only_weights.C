...
void fitJ2_Only_weights(){
  ...
  RooRealVar Psi1To2_dY("Psi1To2_dY","Psi1To2_dY",0,3.5);
  RooRealVar Weight("Weight","Weight",-10,10);
  RooRealVar Weight_nlo("Weight_nlo","Weight_nlo",-10,10);
  ...
  //systematic variation of the above two
  //jpsi2_width_2 = new RooRealVar("jpsi2_width_2","",7.80910e-02);
  //frac_2 = new RooRealVar("frac_2","",9.39822e-01);
...
//mass 2 bkg shape
 // bkg_p3mass2 = new RooRealVar("bkg_p3mass2","",0,-1,1);
  ...
  RooArgSet dataVars(FourMu_Mass,FourMu_pT,Psi1To2_dY,Psi1_Mass, Psi2_Mass, FourMu_RapidityAbs, Weight, Weight_nlo); 
  RooDataSet* readdata = RooDataSet::read("DPSweights.txt",dataVars);
  //RooDataSet* readdata = RooDataSet::read("DPSweights_syst_fixdps_floatnlo.txt",dataVars);
  RooDataSet* readdata = RooDataSet::read("DPSweights_syst_fixnlo_floatdps.txt",dataVars);
  RooDataSet* data ;
  data = new RooDataSet("data","data",readdata ,dataVars,"","Weight");
  ...
  model.fitTo(*data,Extended(kTRUE),SumW2Error(kTRUE),Hesse(kTRUE),Minos(kFALSE));
