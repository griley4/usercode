...
int Xsec_calcTtreeFewerbins_systematic_tozero() {
  gROOT->Reset();
...
dps_frac_mass->SetBinContent(1,0.);
dps_frac_mass->SetBinContent(2,0.);
dps_frac_mass->SetBinContent(3,0.);
dps_frac_mass->SetBinContent(4,0.);
dps_frac_mass->SetBinContent(5,0.);
dps_frac_mass->SetBinContent(6,0.);
dps_frac_mass->SetBinContent(7,0.);
dps_frac_mass->SetBinContent(8,0.);

   TH1D *dps_frac_pt= new TH1D("dps_frac_pt","dps_frac_pt",nptbins, ptbins);
dps_frac_pt->SetBinContent(1,0.);
dps_frac_pt->SetBinContent(2,0.);
dps_frac_pt->SetBinContent(3,0.);
dps_frac_pt->SetBinContent(4,0.);
dps_frac_pt->SetBinContent(5,0.);
dps_frac_pt->SetBinContent(6,0.);
dps_frac_pt->SetBinContent(7,0);

   TH1D *dps_frac_dy= new TH1D("dps_frac_dy","dps_frac_dy",ndybins, dybins);
dps_frac_dy->SetBinContent(1,0.);
dps_frac_dy->SetBinContent(2,0.);
dps_frac_dy->SetBinContent(3,0.);
dps_frac_dy->SetBinContent(4,0.);
dps_frac_dy->SetBinContent(5,0.);
dps_frac_dy->SetBinContent(6,0.);
dps_frac_dy->SetBinContent(7,0.);
dps_frac_dy->SetBinContent(8,0.);

   TH1D *dps_frac_y = new TH1D("dps_frac_y","dps_frac_y",nybins, ybins);
dps_frac_y->SetBinContent(1,0.);
dps_frac_y->SetBinContent(2,0.);
dps_frac_y->SetBinContent(3,0.);
dps_frac_y->SetBinContent(4,0.);
dps_frac_y->SetBinContent(5,0.);
dps_frac_y->SetBinContent(6,0.);
dps_frac_y->SetBinContent(7,0.);
dps_frac_y->SetBinContent(8,0.);
dps_frac_y->SetBinContent(9,0.);
