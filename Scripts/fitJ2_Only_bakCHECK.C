...
void fitJ2_Only_bakCHECK(){
  ...
  RooRealVar Psi1To2_dY("Psi1To2_dY","Psi1To2_dY",0,2.4);
  //RooRealVar Psi1To2_dY("Psi1To2_dY","Psi1To2_dY",-100.,100);

  jpsi2_mass_1 = new RooRealVar("jpsi2_mass_2","",3.09167e+00);
  //jpsi2_mass_1 = new RooRealVar("jpsi2_mass_2","",3.09167e+00,2.9,4);
  jpsi2_width_1 = new RooRealVar("jpsi2_width_1","",2.92269e-02);
  //jpsi2_width_1 = new RooRealVar("jpsi2_width_1","",2.92269e-02,9e-3,1);
...
//mass 2 bkg shape
 // bkg_p3mass2 = new RooRealVar("bkg_p3mass2","",0,-1,1);
  ...
  RooRealVar nbkg("nbkg","number of background events",5,1,1005);
  //RooRealVar nbkg("nbkg","number of background events",3.554);
