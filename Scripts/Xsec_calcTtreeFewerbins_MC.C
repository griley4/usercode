...
int Xsec_calcTtreeFewerbins_MC() {
  gROOT->Reset();
  ...
  mass_nlo->SetBinContent(1,160.); 
  mass_nlo->SetBinContent(2,299.);   
  mass_nlo->SetBinContent(3,205.);
  mass_nlo->SetBinContent(4,164.);
  mass_nlo->SetBinContent(5,190.);
  mass_nlo->SetBinContent(6,227.);
  mass_nlo->SetBinContent(7,71.);
  mass_nlo->SetBinContent(8,69.);
  mass_nlo->SetBinError(1,13.); 
  mass_nlo->SetBinError(2,17.);   
  mass_nlo->SetBinError(3,14);
  mass_nlo->SetBinError(4,13);
  mass_nlo->SetBinError(5,14);
  mass_nlo->SetBinError(6,15);
  mass_nlo->SetBinError(7,8);
  mass_nlo->SetBinError(8,8);
  pt_nlo->SetBinContent(1,155.);
  pt_nlo->SetBinContent(2,140.);
  pt_nlo->SetBinContent(3,153.);
  pt_nlo->SetBinContent(4,239.);
  pt_nlo->SetBinContent(5,312.);
  pt_nlo->SetBinContent(6,411.);
  pt_nlo->SetBinContent(7,10.);
  pt_nlo->SetBinError(1,12);
  pt_nlo->SetBinError(2,12);
  pt_nlo->SetBinError(3,12);
  pt_nlo->SetBinError(4,15);
  pt_nlo->SetBinError(5,18);
  pt_nlo->SetBinError(6,20);
  pt_nlo->SetBinError(7,3);
  dy_nlo->SetBinContent(1,572.);
  dy_nlo->SetBinContent(2,363.);
  dy_nlo->SetBinContent(3,238.);
  dy_nlo->SetBinContent(4,132.);
  dy_nlo->SetBinContent(5,76.);
  dy_nlo->SetBinContent(6,31.);
  dy_nlo->SetBinContent(7,5.);
  dy_nlo->SetBinContent(8,3.);
  dy_nlo->SetBinError(1,24);
  dy_nlo->SetBinError(2,16);
  dy_nlo->SetBinError(3,15);
  dy_nlo->SetBinError(4,11);
  dy_nlo->SetBinError(5,9);
  dy_nlo->SetBinError(6,6);
  dy_nlo->SetBinError(7,2);
  dy_nlo->SetBinError(8,2);
  y_nlo->SetBinContent(1,108);
  y_nlo->SetBinContent(2,112);
  y_nlo->SetBinContent(3,134);
  y_nlo->SetBinContent(4,137);
  y_nlo->SetBinContent(5,185);
  y_nlo->SetBinContent(6,167);
  y_nlo->SetBinContent(7,225);
  y_nlo->SetBinContent(8,223);
  y_nlo->SetBinContent(9,122);    
  y_nlo->SetBinError(1,10);
  y_nlo->SetBinError(2,11);
  y_nlo->SetBinError(3,12);
  y_nlo->SetBinError(4,12);
  y_nlo->SetBinError(5,14);
  y_nlo->SetBinError(6,13);
  y_nlo->SetBinError(7,15);
  y_nlo->SetBinError(8,15);
  y_nlo->SetBinError(9,11);    
...
tnp_diff_y->SetBinContent(9,  0.16372 );
  ...
  for(int mbin=1; mbin<=nmbins; ++mbin){
    corrPop = mass_nlo->GetBinContent(mbin)/(0.0593*0.0593*20.339*(1+0.5*tnp_diff_m->GetBinContent(mbin))*((dps_frac_mass->GetBinContent(mbin)*acc_eff_shape_dps->GetBinContent(mbin))+((1-dps_frac_mass->GetBinContent(mbin))*acc_eff_shape_nlo->GetBinContent(mbin)))*(massbins[mbin]-massbins[mbin-1]));
    xsec_mass->SetBinContent(mbin+1,corrPop*1e-6);
    xsec_sum_mass = xsec_sum_mass+(corrPop*1e-6*(massbins[mbin]-massbins[mbin-1]));
    xsec_mass->SetBinError(mbin+1, xsec_mass->GetBinContent(mbin+1)*(mass_nlo->GetBinError(mbin)/mass_nlo->GetBinContent(mbin)));
    xsecerr_sum_mass = 0;
  }
  for(int ptbin=1; ptbin<=nptbins; ++ptbin){
    corrPoppt = pt_nlo->GetBinContent(ptbin)/(pow(0.0593,2)*20.339*(1+0.5*tnp_diff_pt->GetBinContent(ptbin))*((dps_frac_pt->GetBinContent(ptbin)*acc_eff_shape_dps_pt->GetBinContent(ptbin))+((1.-dps_frac_pt->GetBinContent(ptbin))*acc_eff_shape_nlo_pt->GetBinContent(ptbin)))*(ptbins[ptbin]-ptbins[ptbin-1]));
...
//            std::cout<<pt_data->GetBinContent(ptbin)<<" over "<<0.0593*0.0593*20.339<<" times "<<fracDPS<<" times "<<acc_eff_shape_dps_pt->GetBinContent(ptbin)<<" + "<<fracNLO<<" times "<<acc_eff_shape_nlo_pt->GetBinContent(ptbin)<<" times "<<(ptbins[ptbin]-ptbins[ptbin-1])<<" equals??? "<<corrPoppt<<std::endl;
    ...
    xsec_pt->SetBinError(ptbin, xsec_pt->GetBinContent(ptbin)*(pt_nlo->GetBinError(ptbin)/pt_nlo->GetBinContent(ptbin)));
  }
  for(int dybin=1; dybin<=ndybins; ++dybin){
    corrPopdy = dy_nlo->GetBinContent(dybin)/(pow(0.0593,2)*20.339*(1+0.5*tnp_diff_dy->GetBinContent(dybin))*(dps_frac_dy->GetBinContent(dybin)*acc_eff_shape_dps_dy->GetBinContent(dybin)+(1-dps_frac_dy->GetBinContent(dybin))*acc_eff_shape_nlo_dy->GetBinContent(dybin))*(dybins[dybin]-dybins[dybin-1]));
    ...
    xsec_dy->SetBinError(dybin, xsec_dy->GetBinContent(dybin)*(dy_nlo->GetBinError(dybin)/dy_nlo->GetBinContent(dybin)));
  }
  for(int ybin=1; ybin<=nybins; ++ybin){
    corrPopy = y_nlo->GetBinContent(ybin)/(pow(0.0593,2)*20.339*(1+0.5*tnp_diff_y->GetBinContent(ybin))*(dps_frac_y->GetBinContent(ybin)*acc_eff_shape_dps_y->GetBinContent(ybin)+(1-dps_frac_y->GetBinContent(ybin))*acc_eff_shape_nlo_y->GetBinContent(ybin))*(ybins[ybin]-ybins[ybin-1]));
    //          std::cout<<dy_data->GetBinContent(dybin)<<" over "<<0.0593*0.0593*20.339<<" times "<<((fracDPS*acc_eff_shape_dps_dy->GetBinContent(dybin))+(fracNLO*acc_eff_shape_nlo_dy->GetBinContent(dybin)))<<" times "<<(dybins[dybin]-dybins[dybin-1])<<" equals??? "<<corrPopdy<<std::endl;
    xsec_y->SetBinContent(ybin,corrPopy*1e-6);
    xsec_sum_y = xsec_sum_y+(corrPopy*1e-6*(ybins[ybin]-ybins[ybin-1]));
    xsec_y->SetBinError(ybin, xsec_y->GetBinContent(ybin)*(y_nlo->GetBinError(ybin)/y_nlo->GetBinContent(ybin)));
  }
