...
class PATEventTree : public edm::EDAnalyzer {
 ...
 private:
  ...
  int   fPcN, fTkN, fMuN, fElecN, fMiscTkN, fPhotN, fgsmN, fgsmmN,fgtmN, bestProb, bestProb1, bestProb2 ; //fHadrN, 
...
//  IntMatrix fMuChambers[PARTMAX]; 
  ...
  bool fJPsiMuCutKin[JPsiMAX][2], fJPsiMuCutHLT[JPsiMAX][2], fJPsiMuCutIso[JPsiMAX][2], fJPsiMuCutSA[JPsiMAX][2], fJPsiMuCutTrk[JPsiMAX][2], fJPsiMuType[JPsiMAX][2][5], fJPsiSoftFilter[JPsiMAX], fJPsiSoftModFilter[JPsiMAX];
  ...
  bool fEtabSoftFilter[ETABMAX], fEtabDJSoftFilter[ETABMAX],fEtabUpsSoftFilter[ETABMAX];
  bool fEtabSoftModFilter[ETABMAX], fEtabDJSoftModFilter[ETABMAX],fEtabUpsSoftModFilter[ETABMAX];
  // isolation information
  int fEtabJPsiIsoTkN[ETABMAX][2], fEtabBestDJSoftProbI, fEtabBestUpsSoftProbI, fEtabBestDJSoftModProbI, fEtabBestUpsSoftModProbI;
